...
let parent = function
  | External s -> external_ (Filename.dirname s)
  | (In_source_tree "" | In_build_dir "") as t -> t
  | In_source_tree l -> in_source_tree (Local.parent l)
  | In_build_dir l -> in_build_dir (Local.parent l)
