  ...
  $ mkdir -p symlink-outside-root
  $ cd symlink-outside-root && ln -nfs ../sample-exe sample
  ...
  $ cd symlink-outside-root2/other/a && ln -nfs ../b x
  $ cd symlink-outside-root2/other/b && ln -nfs ../a x
  $ cd symlink-outside-root2/root && ln -nfs ../other src
  ...
  $ cd symlink-outside-root3/root  && ln -nfs ../other src
  $ cd symlink-outside-root3/other && ln -nfs ../other foo
