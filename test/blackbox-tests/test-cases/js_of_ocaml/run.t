  $ $JBUILDER build -j0 --root . --dev bin/technologic.bc.js @install lib/x.cma.js lib/x__Y.cmo.js bin/z.cmo.js
        ocamlc lib/stubs.o
  ...
  break it
  fix it
  $ $JBUILDER build -j0 --root . bin/technologic.bc.js @install
        ocamlc lib/x__.{cmi,cmo,cmt}
      ocamlopt lib/x__.{cmx,o}
        ocamlc lib/x__Y.{cmi,cmo,cmt}
      ocamlopt lib/x__Y.{cmx,o}
